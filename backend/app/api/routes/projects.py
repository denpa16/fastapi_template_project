...
@router.get("/projects/get_multiple")
...
@router.get("/projects/{id}/get_one")
...
@router.get("/projects/delete_multiple")
...
@router.get("/projects/{id}/delete_one")
...
@router.get("/projects/{id}/update_one")
...
@router.get("/projects/update_multiple_by_pk")
...
@router.get("/projects/update_multiple_by_field")
...
@router.get("/projects/create_one")
...
@router.get("/projects/create_multiple")
